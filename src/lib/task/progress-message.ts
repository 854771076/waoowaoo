...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.GRID_SPLIT_ENHANCE]: 'progress.taskType.gridSplitEnhance',
  ...
  [TASK_TYPE.IMAGE_PROJECT_COVER]: 'progress.taskType.projectCover',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  enhance_grid_split: 'progress.stage.enhanceGridSplit',
  persist_grid_split_enhance: 'progress.stage.persistGridSplitEnhance',
